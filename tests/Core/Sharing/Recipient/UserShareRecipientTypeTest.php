...
final class UserShareRecipientTypeTest extends TestCase {
	...
	public function setUp(): void {
		...
		$this->user4->setSystemEMailAddress('example@example.com');
	...
	public function testSearchRecipients(): void {
		...
		$this->assertEquals(array_map($generateRecipient(...), ['user4']), $this->recipientType->searchRecipients($accessContext, 'example@example.com', 1, 0));
	}
}
