...
class Application extends App implements IBootstrap {
	...
	public function register(IRegistrationContext $context): void {
		...
		$registry->markPropertyTypeCompatibleWithRecipientType(LabelSharePropertyType::class, UserShareRecipientType::class);
		$registry->markPropertyTypeCompatibleWithRecipientType(LabelSharePropertyType::class, GroupShareRecipientType::class);
